...
class HydrogenStorage(GenericStorage):
    """Wasserstoffspeicher auf Basis von oemof.solph GenericStorage.

    Die Klasse bildet einen Wasserstoffspeicher ab.
    Sie kann für feste oder investiv optimierte H2-Speicherkapazitäten verwendet werden.
    ...
    def __init__(
        ...
        """Initialisiert einen Wasserstoffspeicher.
        ...
        bus_in_hydrogen:
            Wasserstoff-Eingangsbus des Speichers.
        bus_out_hydrogen:
            Wasserstoff-Ausgangsbus des Speichers. Wenn `None`, wird der Eingangsbus verwendet.
        age_installed:
        ...
        if bus_out_hydrogen is None:
            bus_out_hydrogen = bus_in_hydrogen
        ...
        self.name = name
        self.bus_in_hydrogen = bus_in_hydrogen
        self.bus_out_hydrogen = bus_out_hydrogen
        ...
        super().__init__(
            label=name,
            inputs={
                bus_in_hydrogen: make_storage_flow(
                    optimize_cap=optimize_cap,
                    installed_capacity=installed_capacity,
                    crate=crate,
            ...
            outputs={
                bus_out_hydrogen: make_storage_flow(
                    optimize_cap=optimize_cap,
                    installed_capacity=installed_capacity,
                    crate=crate,
                    variable_costs=0,
